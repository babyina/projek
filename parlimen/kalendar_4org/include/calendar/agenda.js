...
function fHoliday(y,m,d) {
	...
	if (m==1&&d==1)
		r=[" Jan 1, "+y+" \n Selamat Tahun Baru! ",gsAction,"skyblue","red"];
	else if (m==5&&d==1)
		r=[" May 1, "+y+" \n Hari Buruh ",gsAction,"skyblue","red"];
	else if (m==1&&d<25) {
		var date=fGetDateByDOW(y,1,3,6);	// Sabtu Ketiga untuk bulan Januari
		if (d==date) r=[" Jan "+d+", "+y+" \n Sabtu Ketiga ",gsAction,"skyblue","red"];
	}
