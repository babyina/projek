//Calendar
	...
	if (browser.dom || browser.ie4){
		...
		browser.platform=='Win32'?height=120:height=125;
	...
	function calendarTimeout(){
	  ...
	  if (browser.ns6 || browser.ns4){
	    timeoutId=setTimeout('.hide();',timeoutDelay);
	  }
	}
	...
	Calendar.prototype.buildString = function(){
	  ...
	  if (this.hasDropDown) {
	    ...
	    tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td><a href="javascript: g_Calendar.changeMonth(-1);">b</a></td><td class="cal" width="100%" align="center">' + this.months[this.month] + '</td><td class="cal"><a href="javascript: g_Calendar.changeMonth(+1);">n</a></td></tr></table>';
	  }
	  tmpStr += '</td>';
	  ...
	  */
	  ...
	  tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td class="cal"><a href="javascript: g_Calendar.changeYear(-1);">b</a></td><td class="cal" width="100%" align="center">' + this.year + '</td><td class="cal"><a href="javascript: g_Calendar.changeYear(+1);">n</a></td></tr></table>'
	  }
	  tmpStr += '</td>';
	  tmpStr += '</tr>';
	  tmpStr += '</table>';
...
//document.g_Calendar.form[0].tarikh	
//	 g_Calendar.show(event,'tarikh',false); return false;
//g_Calendar.show(event,'calendar.tarikh',true,'yyyy-mm-dd'); return false;

	Calendar.prototype.clickDay = function(day){
	   var tmp = eval('document.' + this.target);
	   //this.tarikh = '21/02/2002';
	   //var tmp = eval('document.' + this.tarikh);
	   ...
	   //if (this.dateFormat=='dd/mm/yyyy' || this.dateFormat=='dd-mm-yyyy') document.form[0].tarikh.value = day + this.dateDelim + (this.month+1) + this.dateDelim + this.year;
	   //if (this.dateFormat=='yyyy-mm-dd') document.calendar.tarikh.value = '2002/12/21';
