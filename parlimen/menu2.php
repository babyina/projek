...
include("config.php");
//check user level
$qry = "SELECT Modul1,Modul2,Modul3,Modul4,Modul5 FROM pengguna WHERE Id ='".$_SESSION['userid']."'";
...
?>  
  ...
  <table border=0>
	...
	<tr><td width=150 /><td class="tdm"><?php echo showMenu("MAKLUM BALAS SOALAN PARLIMEN","parlimen/",$modul1,$icon); ?></td><td class="tdm"><?php echo showMenu("KALENDAR PARLIMEN","kalendar/",$modul3,$icon); ?></td></tr>
	<tr><td width=150 /><td class="tdm"><?php echo showMenu("MAKLUM BALAS JEMAAH MENTERI","kabinet/",$modul2,$icon); ?></td><td class="tdm"><?php echo showMenu("PROFIL","profil/",$modul4,$icon); ?></td></tr>
	<tr><td width=150 /><td class="tdm"><?php echo showMenu("PENTADBIRAN SISTEM","admin/",$modul5,$icon); ?></td><td></td></tr>
  </table>  
  </div>