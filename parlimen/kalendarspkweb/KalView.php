<?php
	...
	if($view_name == "byrakyat"){
		...
		$qry_all = "SELECT m.Kal_mesyuarat_id,m.Parlimen,m.Penggal,m.Sesi,m.Mesyuarat FROM kal_mesyuarat AS m";
		$qry = "SELECT m.Kal_mesyuarat_id,m.Parlimen,m.Penggal,m.Sesi,m.Mesyuarat FROM kal_mesyuarat AS m WHERE Sesi='2' LIMIT $offset,$pgRow";
		...
		<div class="tajuk">Kalendar - Dewan Negara</div>
		<?php
		$view->out();
