...
<table  align="center" width="900" border="1" cellpadding="0" cellspacing="0" >
  ...
  <tr> 
    ...
    <div style="width:716">
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" >
        <tr>
          <td width="80%" >
		  	<form name="login" action="checkLoginldap.php" method="POST">
          <?php			
  ...
  <tr>
    ...
    <td width="28%"><input class="txt" name="userid" type="text" id="userid" maxlength="20" size="20"  onMouseUp="number_only(this,event);"  onKeyPress="number_only(this,event);"></td>
     <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="25" >&nbsp;</td>
...
//--------- auto-generated from table pengguna ----------------------------------------------notify
	...
	$query = "SELECT nama,jawatan,emel,telefon, handphone FROM pengguna WHERE roles LIKE '%3%' and modul1=1 and jawatan LIKE 'PP%' and agensi_id='40' order by jawatan";
...
?>	
	...
	<center>
	  <?php echo $nama ?>    ::   <?php /*echo $jawatan*/ ?>   ::   <?php echo $telefon ?>    
	</center>
...
<?php
	...
	?>
	<center>
	<?php echo  "Helpdesk SSJP :: ssjp@moh.gov.my"; ?>
	</center>
	<br/>	</td>  
  </tr>
</table>
