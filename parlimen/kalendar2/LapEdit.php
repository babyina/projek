...
<table border=0 width="100%">
	...
	<tr>
		<td width="201">Soalan Ditujukan Kepada PM/Menteri Lain Yang Berkaitan Dengan Hal Ehwal KWP</td><td><strong>:</strong></td>
		<td>
...
<table border=0 width="100%">
	...
	<tr>
      <td width="203">Isu Berkaitan Dengan KWP</td>
	  <td width="5"><strong>:</strong></td>
	...
	<tr>
		<td>Rang Undang-undang Berkaitan Dengan KWP</td>
		<td><strong>:</strong></td>
		<td>
