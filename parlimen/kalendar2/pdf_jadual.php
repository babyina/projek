...
$query = "select Tarikh, Sesi, PegawaiBtugas, Dewan from kal_pegawaitugas where Kal_mesyuarat_id = '$mesyuarat_id' order by Tarikh";
...
while($row = mysql_fetch_array($sql)){
	...
	$pdf->SetWidths(array(3,4,16,4.5));
 	...
 	//if($row[1] == "CUTI"){
	//	$pdf->Row(array($print_hari,$print_date,'CUTI',''));
	//}else{
		$pdf->Row(array($print_hari,$print_date,$pegawai,$sesi));
	//}
