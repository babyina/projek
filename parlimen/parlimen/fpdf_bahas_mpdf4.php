...
$namamp= $html_2."<body><div align='left'><strong>DARIPADA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:".$YB."</strong></div></body>";
$namamp2=$html_2."<body><table width=100% border=0 >
<tr>
   <td width=127>DARIPADA</td>
    <td width=25>:</td> 
	 <td >".$YB."</td>
...
if($nama_kawasan!="")
{
$kawasan=$html_2."<body><div align='left'><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[".$nama_kawasan."]</strong></div></body>";
...
$tanyaan=$html_2."<body><div align='left'><strong>PERTANYAAN  &nbsp;&nbsp;:".strtoupper($rows['bentuk_soalan'])."</strong></div></body>";
$tanyaan2="<strong><table width=100% border=0>
<tr>
   <td width=127>PERTANYAAN </td>
    <td width=25>:</td>
    <td>".strtoupper($rows['bentuk_soalan'])."</td>
  </tr>
</table></strong>";

$tarikh=$html_2."<body><div align='left'><strong>TARIKH &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:".date("d/m/Y",strtotime($rows['tkh_bentang_jawapan']))."</strong></div></body>";
...
$makTamb =$html_2."<body><div class='style1'><p align='justify'>".$makTamb."</p></div></body>";
 if($status!=9)
{
$jawapan_= $html_2."<div align='left'><strong>DRAF JAWAPAN BAHAGIAN/AGENSI</strong></div></body>"; 
}
else
{
$jawapan_= $html_2."<div align='left'><strong>JAWAPAN DILULUSKAN </strong></div></body>"; 
}
