...
<table width=100%>
	...
	<tr><td width=120>Sesi</td><td width=5>:</td><td>Dewan Rakyat </td></tr>
	<tr><td width=120>Gelaran/Pangkat</td><td width=5>:</td><td><input name="pangkat" value="Y.B <?php echo $pangkat ?>" size=70 class="txt"/></td></tr>
	<tr><td width=120>Nama Y.B</td><td width=5>:</td><td><p><input name="nama_yb" value="<?php echo $nama_yb ?>" size=70 class="txt"/></p></tr>
	<tr><td width=120>Kawasan Parlimen </td><td width=5>:</td><td><select name="Kawasan" >
	  <option></option><?php getKawasan($kawasan_id,$conn) ?></select></td>
	</tr>
	<tr><td width=120>Parti Diwakili </td><td width=5>:</td><td><p><select name="Parti">
	  <option></option><?php getParti($parti_id,$conn) ?></select>
	</p></td></tr>
	<tr><td width=120>&nbsp;</td><td>&nbsp;</td>
	  <td>&nbsp;</td>
	</tr>
</table>
