<?php
	...
	if($view_name == "bynama"){		
		...
		$name = ($sort=="asc")?"<img src=\"../images/altasc.gif\">Nama Y.B<a href='index.php?action=list&view=bynama&sort=desc&start=$start'><img src=\"../images/desc.gif\" border=\"0\"></a>":
		"<a text-decoration:none; href='index.php?action=list&view=bynama&sort=asc&start=$start'><img src=\"../images/asc.gif\" border=\"0\"></a>Nama Y.B<img src=\"../images/altdesc.gif\">";	
	...
	if($view_name == "bynama2"){		
		...
		$sort = isset($_GET['sort'])?$_GET['sort']:'asc';
		$start = isset($_GET['start'])?$_GET['start']:"";
		$name = ($sort=="asc")?"<img src=\"../images/altasc.gif\">Nama Y.B<a href='index.php?action=list&view=bynama2&sort=desc&start=$start'><img src=\"../images/desc.gif\" border=\"0\"></a>":
		"<a text-decoration:none; href='index.php?action=list&view=bynama2&sort=asc&start=$start'><img src=\"../images/asc.gif\" border=\"0\"></a>Nama Y.B<img src=\"../images/altdesc.gif\">";	
		$sortAhli = $start<>""?" AND ahli_parlimen.nama LIKE '$start%'":"";
		...
		$view->query_all = $qry_all;
		$view->query = $qry;
		$view->col = array("negeri");				
		$view->header = array($name,"Negeri");
		$view->key = array("id","nama");
	...
	/*if($view_name == "bynegeri"){		
		...
		$view->query = $qry;
		$view->col = array("nama");				
		$view->header = array("Negeri","Nama Y.B");
