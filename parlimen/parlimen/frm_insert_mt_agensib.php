...
if($_GET["id"])
{
	...
	$qry = "select tambahan from bahas_agensi where id='$id'";
...
<table width="100%" border="0">
   ...
   <tr>
  	...
  	<td colspan="2"><input name="button" type="button" class="button" onclick="window.close()" value="TUTUP" />
		     <input class="button" type="submit" name="Submit" value="SIMPAN" onclick="window.opener.edit_jawapanb.Tambahan.value = window.soalan.Jawapan.value; window.close()"/><br /><br /></td>		
  </tr>
     <tr>
  	<td width="6%">&nbsp;</td>
