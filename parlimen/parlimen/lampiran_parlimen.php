...
//===================================================
function insert_db($jawapan_id, $parlimen_id, $file_name)
{
	//if(!empty($content))
	//{					
		#gantikan dgn table parlimen in future
		$file_name=mysql_escape_string($file_name);
		$result = mysql_query("insert into parlimen_lampiran(jawapan_id, parlimen_id, nama_fail) values('$jawapan_id', '$parlimen_id', '$file_name')") or die (mysql_error());
		if($result)
			return true;
		else
			return false;
...
$image_dir = '/ssjp/parlimen/parlimen/lampiran/';  
    //$image_dir = '/parlimen/parlimen/lampiran/'; 
   //ditambah directory /ssjp/ 090810
  		...
  		case 0:
			...
			/*
				...
				{			
					...
					if(insert_db($jawapan_id, $parlimen_id, $file['name']) == true)
					 //echo "case 0";
