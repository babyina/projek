    ...
    $destination = $_SERVER['DOCUMENT_ROOT'].$image_dir;
			...
			function insert_db($jawapan_id, $parlimen_id, $file_name, $content)
			{
				...
				{					
					...
					$result = mysql_query("insert into parlimen_lampiran(jawapan_id, parlimen_id, nama_fail, kandungan) values('$jawapan_id', '$parlimen_id', '$file_name', '$content')") or die (mysql_error());
					if($result)
						return true;
					else
						return false;
