...
if(document.getElementById("lpbyrequestid").value=="")
{
alert("Masukkan ISU")
return false;
}
...
<form name="borang" method="post" action="lap_bypdf.php" target="_blank" >  
<fieldset>
...
<tr><td width="0"/>
<td width="170">Carian ISU </td>
<td width="10">:</td><td width="488">
		<input name="lpbyrequest" type="text" id="lpbyrequestid" size="50"   style="text-transform:uppercase "></td></tr>
</table>	
</div>

</fieldset>
&nbsp;&nbsp;<br>
<input  type="submit" value="CETAKAN" class="button"  onClick="return semak(this)" />
