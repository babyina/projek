...
$qry = "SELECT id,parlimen_id,keterangan_tambahan FROM parlimen_agensi WHERE id='$jawapan_id'  AND parlimen_id='$id'";
$result = mysql_query($qry,$conn);

$row = mysql_fetch_array($result);
$paparan = $row['keterangan_tambahan'];
$tajuk = "Keterangan Tambahan dari ".$name;
...
<title>Keterangan Tambahan dari <?php echo $name ?></title>
