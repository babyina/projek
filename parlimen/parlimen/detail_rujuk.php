...
if($isPengesahan ||$isPengurusan || ($isPegawai && $status==9) ||($isHEK && $status==9)||($isPegawaiview && $status==9)){?> 
<fieldset class="<?php echo highlight($status==3|| $status == 4 || $status==5||$status==7||$status==8||$status=23) ?>"><legend><b>UNIT KHAS</b></legend>
<div class="sub">
	<table border=0 width="100%">
		<tr>
		  <td>&nbsp;</td>
...
<div class="sub">
	...
	<?php
		if(($status_urus==4 || $status_urus==7) && ($isPengurusan) && (!$isHEK) && ($atasan_valid=="true")){	//pengurusan
