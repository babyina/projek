...
$qry_agensi			= "SELECT * FROM parlimen_agensi WHERE parlimen_id='$id' AND agensi_id ='$agensi_id'";
mysql_select_db($db_voffice,$conn) or die(mysql_error());
$result_agensi 		= mysql_query($qry_agensi,$conn) or die(mysql_error());
$rows_agensi 		= mysql_fetch_array($result_agensi);

//echo $qry_agensi;

$jawapan_agensi=$rows_agensi['jawapan'];
$makTamb_agensi=$rows_agensi['tambahan'];
$penyedia_nama =$rows_agensi['penyedia_nama'];
$penyedia_jawatan =$rows_agensi['penyedia_jawatan'];
$pengesah_nama =$rows_agensi['pengesah_nama'];
$pengesah_jawatan =$rows_agensi['pengesah_jawatan'];
...
<!--<table width="100%" border="0" align="center">
  ...
  <tr>
    <td valign="top" colspan="3" class="style1"><div align="justify"><?php echo $jawapan_agensi?></div></td>
  </tr>
</table>-->
...
<table width="100%" border="0" align="center">
  ...
  <tr>
    <td colspan="3" class="style1"><div align="justify"><?php echo $makTamb_agensi ?> </div></td>
  </tr>
  <tr>
    <td class="style1">&nbsp;</td>
    <td class="style1">&nbsp;</td>
...
<table width="100%" border="0" align="center">
 <tr>
    ...
    <td valign="top" width="893" class="style1"><?php echo $penyedia_nama?> </td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>JAWATAN</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $penyedia_jawatan?></td>
  </tr>
  ...
  <tr>
    ...
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $pengesah_nama ?> </td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>JAWATAN</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $pengesah_jawatan?></td>
  </tr>
  <tr>
    <td valign="top" class="style1">&nbsp;</td>
    <td valign="top"  class="style1">&nbsp;</td>
