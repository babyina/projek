...
<table width="100%" border="0" align="center">
 <tr>
    ...
    <td valign="top" width="893" class="style1"><?php echo $created_by?> </td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>JAWATAN</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $row['jawatan']?></td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>NO. TELEFON</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $row['telefon'].$temp." ".$row['handphone'] ?></td>
  </tr>
  <tr>
...
?>  
  ...
  <tr>
    <td valign="top" class="style1"><strong>DIPERAKUKAN OLEH </strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $pengurusan_nama ?> </td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>JAWATAN</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
  ...
  <tr>
    ...
    <td class="style1"><?php echo $row['telefon'].$temp." ".$row['handphone'] ?></td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>TARIKH</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
...
?>  
  ...
  <tr>
    <td valign="top" class="style1"><strong>DILULUSKAN OLEH </strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo stripslashes($rows['pengesahan_nama'])?></td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>JAWATAN</strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
    <td valign="top" class="style1"><?php echo $rows['pengesahan_jawatan']?></td>
  </tr>
  <tr>
    <td valign="top" class="style1"><strong>NO. TELEFON </strong></td>
    <td valign="top" class="style1"><strong>:</strong></td>
