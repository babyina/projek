...
if ((!isset($relative_script_path)) || (($relative_script_path != ".") && ($relative_script_path != "./phpdig") &&
...
define('PHPDIG_ADM_PASS','xs2admin'); //Password
...
define('SEARCH_DEFAULT_LIMIT',900);      //results per page

define('SPIDER_MAX_LIMIT',900);          //max recurse levels in spider
define('RESPIDER_LIMIT',900);             //recurse respider limit for update
define('LINKS_MAX_LIMIT',20);           //max links per each level
define('RELINKS_LIMIT',1);              //recurse links limit for an update
...
define('PHPDIG_PARSE_PDF','D:/htdocs/parlimen/pdftotext.exe');
...
define('PHPDIG_MSWORD_EXTENSION','.doc');
