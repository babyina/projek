...
session_start();
	...
	$bentuk_soalan=$_POST['bentuk_soalan'];
	//echo $bentuk_soalan;
		$salinan =array();
		$emailpa =array();
		$emailpa2 =array();
...
//	$qry = "UPDATE parlimen_agensi SET agensi_id = '$agensi_id',nama_pegawai = '$nama_pegawai',penyedia_nama = '$penyedia_nama', status=2,penyedia_jawatan = '$penyedia_jawatan',pengesah_nama = '$pengesah_nama',pengesah_jawatan = '$pengesah_jawatan',no_telefon ='$no_telefon',jawapan='$jawapan',tambahan='$tambahan',keterangan_tambahan='$keterangan_tambahan',lampiran='$lampiran',tkh_terima='$date'
	...
	$qry6 = "UPDATE parlimen SET status = 14,jns_soalan='$bentuk_soalan'  WHERE id='$parlimen_id'";
	...
	$rst6_2 =mysql_query($qry6_2,$conn);
	 ...
	 else if ($status==15)   // pindaaan dari tksp
	{
	...
	*/
	...
	if(($restksp=='KSP') && (($bentuk_soalan=='s1')||($bentuk_soalan=='s2')))// edit pada 18/02/2011 kerana tkspsk tiada..
	 {
	 $qry6 = "UPDATE parlimen SET status = 43, penyemak='$restksp',jns_soalan='$bentuk_soalan'  WHERE id='$parlimen_id'";
			mysql_query($qry6,$conn) or die(mysql_error());
		//echo  $qry6;	
	$qry6_1="select jawatan from pengguna where jawatan like 'pa%' and jawatan like '$restksp'";	
	$rst6_1 =mysql_query($qry6_1,$conn);
	...
	else if($bentuk_soalan=='s1')
	{
	$qry6 = "UPDATE parlimen SET status = 41, penyemak='$restksp',jns_soalan='$bentuk_soalan'  WHERE id='$parlimen_id'";
			mysql_query($qry6,$conn) or die(mysql_error());
	...
	$qry6 = "UPDATE parlimen SET status = 42, penyemak='$restksp',jns_soalan='$bentuk_soalan'  WHERE id='$parlimen_id'";
			mysql_query($qry6,$conn) or die(mysql_error());
	...
	//echo $qry6;
	/*19012011 start $qry6 = "UPDATE parlimen SET status = 4, penyemak='$restksp',jns_soalan='$bentuk_soalan'  WHERE id='$parlimen_id'";
			mysql_query($qry6,$conn) or die(mysql_error());
