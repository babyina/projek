...
//  </tr>
//</table></strong>";
$soalan_5="<table width=100% border=0>
<tr>
   <td width=25%><div class='style2'>SOALAN</div></td>
    <td width=2%><div class='style2'>:</div> </td>
...
$jawapan_= $html_2."<div align='left'><strong>Tuan Yang Di-Pertua, </strong></div></body>"; 
}
...
//tukar tempat maklumat tambahan
$mpdf->Addpage();
