...
class View{
	...
	function OutCat(){
		...
		while($row = mysql_fetch_array($this->result)){
			...
			if(!empty($agensi3)){
			 echo "<tr><td colspan=".(count($this->col)+2)."><strong>"."Tindakan Agensi(Telah Dibaca)"."</strong></td></tr>";
			...
			if(!empty($agensi4)){
			 echo "<tr><td colspan=".(count($this->col)+2)."><strong>"."Tindakan Agensi(Telah Hantar)"."</strong></td></tr>";
