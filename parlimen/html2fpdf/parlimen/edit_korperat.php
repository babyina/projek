		...
		<table border=0 width="100%">		
			...
			<table width="727" border="1" color="#006699">
			  <tr><td width="220"><p><center>
				<input type="checkbox" name="Salinan" value="ksp" checked disabled>KSP 
				<input type="checkbox" name="Salinan" value="tkspo" disabled>TKSP(O) 
				<input type="checkbox" name="Salinan" value="tkspp" disabled>TKSP(P)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
