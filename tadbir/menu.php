...
include("config.php");
//check user level
$qry = "SELECT Modul1,Modul2,Modul3,Modul4,Modul5,Modul6 FROM pengguna WHERE Id ='".$_SESSION['userid']."' or nokp='".$_SESSION['userid']."'";
...
?>  
  ...
  <table border=0>
	<tr><td width=150 /><td align="lef"><div style="height:50px;text-align:left">Selamat Datang <?php echo $_SESSION['s_name'] ?></div></td><td align="right" valign="top"><a href="logout.php">Logout</a></td></tr>
	...
	<tr><td width=150 /><td class="tdm"><?php echo showMenu("BAHAGIAN/AGENSI MOH","agensibhgn/",$modul6,$icon); ?></td>
