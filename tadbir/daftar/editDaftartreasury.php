...
<fieldset style="width:90%"><legend style="width:auto">Pendaftaran Pengguna</legend> 
...
<tr>
	...
	<td width=3>:</td>
	<td colspan="2"><input name="Nama2" class="txt" size="40" onBlur="copyNama()"></td>
</tr>
<tr>
	...
	<td width=3>:</td>
	<td colspan="2">
  <select name="Agensi"><option value="0">&nbsp;</option><?php getAgensi($row['agensi_id'],$conn,$kod) ?></select></tr>
<tr>
...
<tr>
	...
	<td width=17><?php print_red("*") ?></td>
	<td width=3>:</td>
	<td colspan="2"><input name="Emel" class="txt" size="40" value="<?php echo $row['emel']; ?>"></td>
</tr>
<tr>
	<td width=174>E-mel Jabatan</td>
	<td width=17><?php print_red("*") ?></td>
	<td width=3>:</td>
	<td colspan="2"><input name="Emel_jab" class="txt" size="40" value=""></td>
</tr>
<tr>
	<td width=174>&nbsp;</td>
	<td width=17>&nbsp;</td>
...
<tr>
	...
	<td width=17><?php print_red("*") ?></td>
	<td width=3>:</td>
	<td colspan="2"><input name="Idkp"  onMouseUp="number_only(this,event);"  onKeyPress="number_only(this,event);" class="txt" size="12" maxlength="12">
	<!--<font style="color:<?php echo $font_color; ?>;">&nbsp;(min = 3 char)</font>-->	</td>
</tr>
...
<tr>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td><input type="checkbox" name="changePwd" id="changePwd" onclick="javascript: enablePassword()" />
    Tukar Katalaluan</td>
</tr>
<tr style="display:display ">
  <td>Katalaluan</td>
...
<tr>
  ...
  <td bgcolor="#E0EEE0">
    ...
    <input type="radio" name="mod3" value="5" class="noBorder" <?php if(($row['modul3'] == 5) || (!isset($row['modul3']))) print "checked" ?>>Tahap 5 
  </td>
</tr>
<!--<tr>
  <td>&nbsp;</td>
...
<tr>
  ...
  <td bgcolor="#E0EEE0">
    ...
    <input type="radio" name="mod5" value="5" class="noBorder" <?php if(($row['modul5'] == 5) || (!isset($row['modul5']))) print "checked" ?>>Tahap 5 
  </td>
</tr>
...
<tr>
  ...
  <td  bgcolor="#E0EEE0">
    ...
    <input type="radio" name="mod6" value="5" class="noBorder" <?php if(($row['modul6'] == 5) || (!isset($row['modul6']))) print "checked" ?>>Tahap 5 
  </td>
</tr>
<tr>
  <td>&nbsp;</td>
