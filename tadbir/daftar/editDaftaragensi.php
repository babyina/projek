...
<fieldset style="width:auto "><legend>Pendaftaran Pengguna -> Agensi</legend>  
...
<tr>
	...
	<td width=3>:</td>
	<td colspan="2"><input name="Nama2" class="txt" size="40"  value="<?php echo stripslashes($row['nama']); ?>"></td>
</tr>
<tr>
...
<tr>
	...
	<td width=17><?php print_red("*") ?></td>
	<td width=3>:</td>
	<td colspan="2"><input name="Emel_jab" class="txt" size="40" value="<?php  ?>"></td>
</tr>
...
<tr>
	...
	<td width=17><?php print_red("*") ?></td>
	<td width=3>:</td>
	<td colspan="2"><input name="Idkp" class="txt" size="12" maxlength="12" value="<?php echo $row['id']; ?>"  onMouseUp="number_only(this,event);"  onKeyPress="number_only(this,event);">
	<!--<font style="color:<?php echo $font_color; ?>;">&nbsp;(min = 3 char)</font>-->	</td>
</tr>
